...
// <button class="sortBtn" id="sortByPriceUp">Sorteaza după preț crescător</button>
// <div class="sortBtn" id="sortByPriceDown"> Sorteaza după preț descrescător </div>
// <div class="sortBtn" id="sortByName"> Sorteaza după preț nume </div>
// </div>  
// `;
...
sortByPriceUp.addEventListener('click', function() {
  sortPhones('sortByPriceUp');
})
